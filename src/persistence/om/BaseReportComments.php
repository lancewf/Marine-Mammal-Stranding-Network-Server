...
/**
 * Base class that represents a row from the 'report_comments' table.
 *
 * comments on a report
 *
 * @package    propel.generator.persistence.om
 */
abstract class BaseReportComments extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ReportCommentsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ReportCommentsPeer
     */
     ...
     * @return ReportComments The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ReportCommentsPeer::ID;
        }
    ...
    public function setIndex($v)
    {
        ...
        if ($this->index !== $v) {
            $this->index = $v;
            $this->modifiedColumns[] = ReportCommentsPeer::INDEX;
        }
    ...
    public function setComments($v)
    {
        ...
        if ($this->comments !== $v) {
            $this->comments = $v;
            $this->modifiedColumns[] = ReportCommentsPeer::COMMENTS;
        }
    ...
    public function setReportId($v)
    {
        ...
        if ($this->report_id !== $v) {
            $this->report_id = $v;
            $this->modifiedColumns[] = ReportCommentsPeer::REPORT_ID;
        }
    ...
    public function setVolunteerId($v)
    {
        ...
        if ($this->volunteer_id !== $v) {
            $this->volunteer_id = $v;
            $this->modifiedColumns[] = ReportCommentsPeer::VOLUNTEER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = ReportCommentsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ReportComments object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ReportCommentsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ReportCommentsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ReportCommentsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ReportCommentsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ReportCommentsPeer::INDEX)) {
            $modifiedColumns[':p' . $index++]  = '`index`';
        }
        if ($this->isColumnModified(ReportCommentsPeer::COMMENTS)) {
            $modifiedColumns[':p' . $index++]  = '`comments`';
        }
        if ($this->isColumnModified(ReportCommentsPeer::REPORT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`report_id`';
        }
        if ($this->isColumnModified(ReportCommentsPeer::VOLUNTEER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`volunteer_id`';
        }

        $sql = sprintf(
            'INSERT INTO `report_comments` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ReportCommentsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ReportCommentsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ReportComments'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ReportComments'][$this->getPrimaryKey()] = true;
        $keys = ReportCommentsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReportCommentsPeer::ID)) $criteria->add(ReportCommentsPeer::ID, $this->id);
        if ($this->isColumnModified(ReportCommentsPeer::INDEX)) $criteria->add(ReportCommentsPeer::INDEX, $this->index);
        if ($this->isColumnModified(ReportCommentsPeer::COMMENTS)) $criteria->add(ReportCommentsPeer::COMMENTS, $this->comments);
        if ($this->isColumnModified(ReportCommentsPeer::REPORT_ID)) $criteria->add(ReportCommentsPeer::REPORT_ID, $this->report_id);
        if ($this->isColumnModified(ReportCommentsPeer::VOLUNTEER_ID)) $criteria->add(ReportCommentsPeer::VOLUNTEER_ID, $this->volunteer_id);
    ...
    {
        $criteria = new Criteria(ReportCommentsPeer::DATABASE_NAME);
        $criteria->add(ReportCommentsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ReportComments (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ReportComments Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ReportCommentsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ReportCommentsPeer();
        }
    ...
    public function getReport(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aReport === null && ($this->report_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aReport->addReportCommentss($this);
             */
        }
    ...
    public function getVolunteer(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aVolunteer === null && ($this->volunteer_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVolunteer->addReportCommentss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ReportCommentsPeer::DEFAULT_STRING_FORMAT);
    }
