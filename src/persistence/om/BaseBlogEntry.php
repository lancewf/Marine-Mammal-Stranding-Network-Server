...
/**
 * Base class that represents a row from the 'blog_entry' table.
 *
 * attachments to a report
 *
 * @package    propel.generator.persistence.om
 */
abstract class BaseBlogEntry extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BlogEntryPeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = BlogEntryPeer::TITLE;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = BlogEntryPeer::MESSAGE;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BlogEntryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BlogEntryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BlogEntryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BlogEntryPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BlogEntryPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(BlogEntryPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`message`';
        }
        if ($this->isColumnModified(BlogEntryPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }

        $sql = sprintf(
            'INSERT INTO `blog_entry` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BlogEntryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BlogEntryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BlogEntryPeer::ID)) $criteria->add(BlogEntryPeer::ID, $this->id);
        if ($this->isColumnModified(BlogEntryPeer::TITLE)) $criteria->add(BlogEntryPeer::TITLE, $this->title);
        if ($this->isColumnModified(BlogEntryPeer::MESSAGE)) $criteria->add(BlogEntryPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(BlogEntryPeer::DATE)) $criteria->add(BlogEntryPeer::DATE, $this->date);
    ...
    {
        $criteria = new Criteria(BlogEntryPeer::DATABASE_NAME);
        $criteria->add(BlogEntryPeer::ID, $this->id);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BlogEntry Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BlogEntryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BlogEntryPeer();
        }
     ...
     * If this BlogEntry is new, it will return
    ...
    public function setBlogEntryCommentss(PropelCollection $blogEntryCommentss, PropelPDO $con = null)
    {
        ...
        foreach ($blogEntryCommentssToDelete as $blogEntryCommentsRemoved) {
            $blogEntryCommentsRemoved->setBlogEntry(null);
        }
    ...
    protected function doAddBlogEntryComments($blogEntryComments)
    {
        ...
        $blogEntryComments->setBlogEntry($this);
    }
    ...
    public function removeBlogEntryComments($blogEntryComments)
    {
        if ($this->getBlogEntryCommentss()->contains($blogEntryComments)) {
            ...
            $blogEntryComments->setBlogEntry(null);
        }
     ...
     * Otherwise if this BlogEntry is new, it will return
     * an empty collection; or if this BlogEntry has previously
     * been saved, it will retrieve related BlogEntryCommentss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in BlogEntry.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|BlogEntryComments[] List of BlogEntryComments objects
     */
    public function getBlogEntryCommentssJoinVolunteer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BlogEntryCommentsQuery::create(null, $criteria);
