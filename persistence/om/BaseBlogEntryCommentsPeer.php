...
abstract class BaseBlogEntryCommentsPeer {
	...
	const CLASS_DEFAULT = 'persistence.BlogEntryComments';
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = BlogEntryCommentsPeer::getOMClass(false);
	...
	{
		return $withPrefix ? BlogEntryCommentsPeer::CLASS_DEFAULT : BlogEntryCommentsPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a BlogEntryComments or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a BlogEntryComments or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the blog_entry_comments table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a BlogEntryComments or Criteria object OR a primary key value.
	 *
