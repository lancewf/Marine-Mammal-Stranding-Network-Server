...
abstract class BaseBlogEntryComments extends BaseObject  implements Persistent
{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(BlogEntryCommentsPeer::ID) ) {
					...
					$affectedRows += BlogEntryCommentsPeer::doUpdate($this, $con);
				}
	 ...
	 * @throws     PropelException
	 */
	public function getBlogEntry(PropelPDO $con = null)
	{
