  ...
  const PEER = 'ReportCommentsPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = ReportCommentsPeer::NUM_COLUMNS - ReportCommentsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->aReport) {
				$result['Report'] = $this->aReport->toArray($keyType, $includeLazyLoadColumns, true);
			}
